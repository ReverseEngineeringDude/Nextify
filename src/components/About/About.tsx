...
const About: React.FC = () => {
  ...
  useEffect(() => {
    if (sectionRef.current) {
      const ctx = gsap.context(() => {
        ...
        // Text paragraphs
        gsap.utils.toArray(".about-text").forEach((el: any, i) => {
          gsap.fromTo(
            el,
            { y: 30, opacity: 0 },
            {
        ...
        // Feature cards
        gsap.utils.toArray(".about-card").forEach((el: any, i) => {
          gsap.fromTo(
            el,
  ...
  const features = [
    { icon: Target, title: "Strategic Vision", description: "We align digital solutions with your business objectives for maximum impact." },
    { icon: Rocket, title: "Innovation First", description: "Cutting-edge technology and creative thinking drive every project we deliver." },
    { icon: Users, title: "Collaborative Approach", description: "Your success is our success. We work as an extension of your team." },
    { icon: Award, title: "Excellence Delivered", description: "Award-winning designs and development that exceed industry standards." },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="about-text text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              We're a forward-thinking digital agency that transforms ambitious ideas into extraordinary digital experiences through innovation, creativity, and technical excellence.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="about-text">
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-6">
                  Founded with a vision to revolutionize digital experiences, Nextify has grown from a passionate startup to a recognized leader in cutting-edge web development and digital strategy.
                </p>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Our team of creative designers, skilled developers, and strategic thinkers work collaboratively to deliver solutions that not only meet today's needs but anticipate tomorrow's opportunities.
                </p>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((f, i) => (
              <div key={i} className="about-card glass-card p-8 hover-tilt hover-glow group">
                <div className="mb-6">
