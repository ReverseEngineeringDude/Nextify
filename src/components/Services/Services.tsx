...
const Services: React.FC = () => {
  ...
  const services: Service[] = [
    ...
    },
    {
      ...
      features: ['React Native', 'Flutter Development', 'Native iOS/Android', 'App Store Optimization', 'Push Notifications'],
      gradient: 'from-cyan-400 to-blue-400'
    },
    {
      icon: ShoppingCart,
      title: 'E-Commerce',
      description: 'Complete e-commerce solutions with secure payment processing.',
      features: ['Shopify Development', 'WooCommerce', 'Payment Integration', 'Inventory Management', 'Analytics Dashboard'],
    ...
    },
    {
      ...
      features: ['User Research', 'Wireframing', 'Prototype Design', 'Design Systems', 'Usability Testing'],
    ...
    },
    {
      ...
      features: ['Social Media Marketing', 'PPC Campaigns', 'Email Marketing', 'Content Marketing', 'Analytics & Reporting'],
    ...
    <>
      <section id="services" ref={sectionRef} className="py-20 relative">
        <div ref={ref} className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <h2 className="services-title text-4xl md:text-5xl lg:text-6xl font-bold mb-6 gradient-text font-space-grotesk">
                Our Services
              </h2>
              <p className="services-subtitle text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <div 
                  key={index} 
                  className="service-card glass-card p-8 hover-tilt hover-glow group cursor-pointer"
                  onClick={() => openModal(service)}
                >
                  <div className="mb-6">
                    <div className={`w-16 h-16 rounded-full bg-gradient-to-r ${service.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
          ...
          <div className="absolute bottom-40 right-10 w-32 h-32 rounded-full bg-gradient-to-r from-cyan-400/20 to-blue-400/20 blur-3xl animate-float" style={{animationDelay: '2s'}}></div>
        </div>
      </section>
          ...
          <div className="glass-card p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-4">
                <div className={`w-12 h-12 rounded-full bg-gradient-to-r ${selectedService.gradient} flex items-center justify-center`}>
